...
$key[0] = "wkr_ls1_varchar1";
$key[1] = "wkr_ls1_varchar2";
$key[2] = "wkr_ls1_varchar3";
$key[3] = "wkr_ls1_datetime1";
$key[4] = "wkr_ls1_datetime2";
$key[5] = "wkr_ls1_datetime3";
$key[6] = "wkr_ls1_numeric1";
$key[7] = "wkr_ls1_numeric2";
...
$sql= "	SELECT 
		...
		WHERE 	wkr_ls1.site_cd = '".$site_cd."'
		AND 	wkr_ls1.mst_RowID = '".$RowID."'";

	$stmt_wkr_ls1 = sqlsrv_query( $conn, $sql);

	if( !$stmt_wkr_ls1 ) {
		 $error_message = "Error selecting table (wkr_ls1)";
	...
	do {
        while ($row = sqlsrv_fetch_array($stmt_wkr_ls1, SQLSRV_FETCH_ASSOC)) {
    ...
    } while (sqlsrv_next_result($stmt_wkr_ls1));
