...
$key[0] = "wko_ls2_assetno";
$key[1] = "wko_ls2_stockno";
$key[2] = "wko_ls2_stk_locn";
$key[3] = "wko_ls2_desc";
$key[4] = "wko_ls2_chg_costcenter";
$key[5] = "wko_ls2_chg_account";
$key[6] = "wko_ls2_qty_needed";
$key[7] = "wko_ls2_mtl_uom";
$key[8] = "wko_ls2_item_cost";

$key[9] = "wko_ls2_mr_no";
$key[10] = "wko_ls2_mr_lineno";
...
$sql= "	SELECT * 
		FROM wko_ls2 (NOLOCK)
		WHERE wko_ls2.site_cd = '".$site_cd."'ORDER BY wko_ls2_assetno";
