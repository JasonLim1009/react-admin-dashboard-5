...
$key[0] = "sup_bil_billto";
$key[1] = "sup_bil_address1";
$key[2] = "sup_bil_address2";
$key[3] = "sup_bil_city";
$key[4] = "sup_bil_state";
$key[5] = "sup_bil_postal_code";
$key[6] = "sup_bil_country";
$key[7] = "sup_bil_phone";
$key[8] = "sup_bil_contact";
...
$sql= "	SELECT * 
		FROM sup_bil (NOLOCK)
		WHERE sup_bil.site_cd = '".$site_cd."'ORDER BY sup_bil_billto";
