...
$key[0] = "puo_sts_st_cat_cd";
$key[1] = "puo_sts_status_type";
$key[2] = "puo_sts_status";
$key[3] = "puo_sts_description";
$key[4] = "puo_sts_email_flag";
$key[5] = "puo_sts_disable_flag";
...
$sql= "	SELECT * 
		FROM puo_sts (NOLOCK)
		WHERE puo_sts.site_cd = '".$site_cd."'ORDER BY puo_sts_st_cat_cd";
