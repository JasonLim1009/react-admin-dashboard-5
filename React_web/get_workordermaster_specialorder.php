...
$key[0] = "wko_ls3_assetno";
$key[1] = "wko_ls3_rec_supplier";

$key[2] = "wko_ls3_descr";
$key[3] = "wko_ls3_tax_cd";
$key[4] = "wko_ls3_mtl_uom";
$key[5] = "wko_ls3_qty_needed";
$key[6] = "wko_ls3_item_cost";
$key[7] = "wko_ls3_chg_costcenter";
$key[8] = "wko_ls3_chg_account";
$key[9] = "wko_ls3_pr_no";
$key[10] = "wko_ls3_pr_lineno";


$key[11] = "wko_ls3_po_no";
$key[12] = "wko_ls3_po_lineno";
...
$sql= "	SELECT * 
		FROM wko_ls3 (NOLOCK)
		WHERE wko_ls3.site_cd = '".$site_cd."'ORDER BY wko_ls3_assetno";
