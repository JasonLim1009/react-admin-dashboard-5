...
$key[0] = "wrk_sts_typ_cd";
$key[1] = "wrk_sts_status";
$key[2] = "wrk_sts_desc";
$key[3] = "wrk_sts_wo_limit";
$key[4] = "wrk_sts_email_flag";
$key[5] = "wrk_sts_template";
$key[6] = "wrk_sts_disable_flag";
...
$sql= "	SELECT * 
		FROM wrk_sts (NOLOCK)
		WHERE wrk_sts.site_cd = '".$site_cd."'ORDER BY wrk_sts_typ_cd";
