...
$key[0] = "sup_shi_shipto";
$key[1] = "sup_shi_address1";
$key[2] = "sup_shi_address2";
$key[3] = "sup_shi_city";
$key[4] = "sup_shi_state";
$key[5] = "sup_shi_postal_code";
$key[6] = "sup_shi_country";
$key[7] = "sup_shi_phone";
$key[8] = "sup_shi_contact";
...
$sql= "	SELECT * 
		FROM  sup_shi (NOLOCK)
		WHERE sup_shi.site_cd = '".$site_cd."'ORDER BY sup_shi_shipto";
