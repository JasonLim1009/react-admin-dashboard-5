...
$key[0] = "prj_mst_prj_cd";
$key[1] = "prj_mst_desc";
$key[2] = "prj_mst_costcenter";
$key[3] = "prj_mst_laccount";
$key[4] = "prj_mst_maccount";
$key[5] = "prj_mst_caccount";
$key[6] = "prj_mst_prj_date";
$key[7] = "prj_mst_due_date";
$key[8] = "prj_mst_budget";
$key[9] = "prj_mst_approved";
$key[10]= "prj_mst_disable_flag";
...
$sql= "	SELECT * 
		FROM  prj_mst (NOLOCK)
		WHERE prj_mst.site_cd = '".$site_cd."'ORDER BY prj_mst_prj_cd";
	...
	do {
		 while ($row = sqlsrv_fetch_array($stmt_prj_mst, SQLSRV_FETCH_ASSOC)) {	
				...
				$row_result["col7"] = validate_date($row[$key[6]]);
				$row_result["col8"] = validate_date($row[$key[7]]);
				$row_result["col9"] = $row[$key[8]];
				$row_result["col10"] = $row[$key[9]];
				$row_result["col11"] = $row[$key[10]];
				$row_result["col12"] = $row["RowID"];
