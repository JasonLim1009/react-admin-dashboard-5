...
$key[0] = "cur_mst_cur_code";
$key[1] = "cur_mst_desc";
$key[2] = "cur_mst_exchange_rate";
$key[3] = "cur_mst_label";
$key[4] = "cur_mst_format_string";
$key[5] = "cur_mst_exchange_rate_date";
$key[6] = "cur_mst_base_cur";
...
$sql= "	SELECT * 
		FROM cur_mst (NOLOCK)
		WHERE cur_mst.site_cd = '".$site_cd."'ORDER BY cur_mst_cur_code";
	...
	do {
		 while ($row = sqlsrv_fetch_array($stmt_cur_mst, SQLSRV_FETCH_ASSOC)) {	
				...
				$row_result["col5"] = validate_date($row[$key[5]]);
				$row_result["col6"] = $row[$key[6]];
