...
$key[0] = "con_sts_cat_cd";
$key[1] = "con_sts_type";
$key[2] = "con_sts_status";
$key[3] = "con_sts_description";
$key[4] = "con_sts_email_flag";
$key[5] = "con_sts_disable_flag";
...
$sql= "	SELECT * 
		FROM con_sts (NOLOCK)
		WHERE con_sts.site_cd = '".$site_cd."'ORDER BY con_sts_cat_cd";
