...
//$password = decrypt($encrypted_message, $nonce, $secret_key);
...
if(isset($_REQUEST['password'])){
	...
	$login_password =myUrlEncode(utf8_encode($_REQUEST['password']));
...
//echo $login_id;
//echo $encodedSecretKey;
//echo $encrypted;
//echo $iv;

//$Crypto= new Crypto();
//$password = $Crypto->decrypt($encrypted, $encodedSecretKey, $iv);
//$cipher="AES-128-CBC";
//$password = openssl_decrypt(base64_decode($encrypted), $cipher, $key, $options=OPENSSL_RAW_DATA, $iv);
//$cipher="AES-128-CBC";
//$password = 'admin';
//$password = openssl_decrypt(base64_decode($encrypted), $cipher, $encodedSecretKey, $options=OPENSSL_RAW_DATA, $iv);
//echo $password;
//$serverName = "DESKTOP-SKIA2BB\\SQL2008EXPRESS";
