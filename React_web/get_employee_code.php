...
$key[0] = "ast_cod_ast_cd";
$key[1] = "ast_cod_desc";
$key[2] = "ast_cod_disable_flag";
...
$sql= "	SELECT * 
	...
	$stmt_asset_Code = sqlsrv_query( $conn, $sql);
	...
	do {
		 while ($row = sqlsrv_fetch_array($stmt_asset_Code, SQLSRV_FETCH_ASSOC)) {	
	...
	} while ( sqlsrv_next_result($stmt_asset_Code) );
...
sqlsrv_free_stmt($stmt_asset_Code);
sqlsrv_close($conn);
