...
$key[0] = "pur_sts_st_cat";
$key[1] = "pur_sts_status";
$key[2] = "pur_sts_description";
$key[3] = "pur_sts_status_type";
$key[4] = "pur_sts_email_flag";
$key[5] = "pur_sts_disable_flag";
...
$sql= "	SELECT * 
		FROM pur_sts (NOLOCK)
		WHERE pur_sts.site_cd = '".$site_cd."'ORDER BY pur_sts_st_cat";
