...
class Navbar extends Component {  
  ...
  toggleOffcanvasIcon() {
    const button = document.querySelector('.navbar-toggler-right');
    const iconDecrease = button.querySelector('.mdi-format-indent-decrease');
    const iconIncrease = button.querySelector('.mdi-format-indent-increase');
    
    document.querySelector('.sidebar-offcanvas').classList.toggle('active');
    
    if (iconDecrease.classList.contains('d-none')) {
      iconDecrease.classList.remove('d-none');
      iconIncrease.classList.add('d-none');
    } else {
      iconIncrease.classList.remove('d-none');
      iconDecrease.classList.add('d-none');
    }
  }
    ...
    return (
      <nav className="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
        ...
        <a className="navbar-brand brand-logo-mini align-self-center d-lg-none" href="!#" onClick={evt =>evt.preventDefault()}><img src={require("../../assets/images/logo-mini.svg")} alt="logo" /></a>
          <button className="navbar-toggler navbar-toggler align-self-center" type="button" onClick={this.toggleSidebarIcon}>
            <i className="mdi mdi-format-indent-decrease"></i>
            <i className="mdi mdi-format-indent-increase d-none"></i>
          </button>
          <label className="col-sm-4 col-form-label">{site_name}</label>
          ...
          <button className="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" onClick={this.toggleOffcanvasIcon}>
            <span className="mdi mdi-format-indent-decrease"></span>
            <span className="mdi mdi-format-indent-increase d-none"></span>
          </button>
        </div>
      </nav>
    );
