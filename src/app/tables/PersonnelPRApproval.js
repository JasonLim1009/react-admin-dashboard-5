...
// **************************************** check read data ******************************************
    ...
    const handleRowClick = (data) => {
        ...
        setCostCenter( data.emp_ls2_costcenter )
        setApprovalLimit( data.emp_ls2_pr_approval_limit )
    ...
    const handleAddButtonClick  = () => {
        ...
        const newPart = {
            ...
            site_cd: site_ID,
            emp_ls2_costcenter: setCostCenter.trim(),
            emp_ls2_pr_approval_limit: ApprovalLimit,
                ...
                <div>
                    <div style={{ paddingBottom: '20px', backgroundColor: 'white' }}>
                        ...
                        <div className="template-demo" style={{ display: 'flex', flexDirection: 'column' }}>
                            <div style={{ marginRight: '10px', fontWeight: 'bold' }}>PR Approval</div>
