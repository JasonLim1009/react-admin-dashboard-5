...
//Master System Default Setting Status
const get_systemdefaultsetting_status = (site_cd) => {
  return http.get(`/get_systemdefaultsetting_status.php?site_cd=${site_cd}`);
};
//Master System Default Setting
const get_systemdefaultsetting_select = (site_cd) => {
  return http.get(
...
const insert_new_workrequest = (data) => {
  return http.post(`/insert_new_workrequest.php?`, data);
};

//Update WorkRequest Master
const update_workrequest = (data) => {
  return http.post(`/update_workrequest.php?`, data);
};

//Insert WorkRequest Approval
const insert_work_request_approval = (data) => {
  return http.post(`/insert_work_request_approval.php?`,data);
};

//Insert WorkRequest Disapproval
const insert_work_request_disapproval = (data) => {
  return http.post(`/insert_work_request_disapproval.php?`,data);
};
...
const get_workrequest_type = (site_cd) => {
  return http.get(`/get_workrequest_type.php?site_cd=${site_cd}`);
};
...
const get_workrequest_type_insert = (data) => {
  return http.post(`/get_workrequest_type_insert.php?`, data);
};

//Update WorkRequest Type
const get_workrequest_type_update = (data) => {
  return http.post(`/get_workrequest_type_update.php?`, data);
};
...
const get_workrequest_group_code = (site_cd) => {
  return http.get(`/get_workrequest_group_code.php?site_cd=${site_cd}`);
};
...
const get_workrequest_groupcode_insert = (data) => {
  return http.post(`/get_workrequest_groupcode_insert.php?`, data);
};

//Update GroupCode
const get_workrequest_groupcode_update = (data) => {
  return http.post(`/get_workrequest_groupcode_update.php?`, data);
};
...
const get_workrequest_code = (site_cd) => {
  return http.get(`/get_workrequest_code.php?site_cd=${site_cd}`);
};
...
const get_workrequest_code_insert = (data) => {
  return http.post(`/get_workrequest_code_insert.php?`, data);
};

//Update WorkRequest Code
const get_workrequest_code_update = (data) => {
  return http.post(`/get_workrequest_code_update.php?`, data);
};
...
const get_workrequest_critical_factor = (site_cd) => {
  return http.get(`/get_workrequest_critical_factor.php?site_cd=${site_cd}`);
};
...
const get_workrequest_criticalfactor_insert = (data) => {
  return http.post(`/get_workrequest_criticalfactor_insert.php?`, data);
};

//Update Critical Factor
const get_workrequest_criticalfactor_update = (data) => {
  return http.post(`/get_workrequest_criticalfactor_update.php?`, data);
};
...
const get_workrequest_status = (site_cd) => {
  return http.get(`/get_workrequest_status.php?site_cd=${site_cd}`);
};
...
const get_workrequest_status_type = (site_cd) => {
  return http.get(`/get_workrequest_status_type.php?site_cd=${site_cd}`);
};

//Insert WorkRequest Status
const get_workrequest_status_insert = (data) => {
  return http.post(`/get_workrequest_status_insert.php?`, data);
};

//Update WorkRequest Status
const get_workrequest_status_update = (data) => {
  return http.post(`/get_workrequest_status_update.php?`, data);
};
...
const get_workrequest_work_area = (site_cd) => {
  return http.get(`/get_workrequest_work_area.php?site_cd=${site_cd}`);
};
...
const get_workrequest_workarea_insert = (data) => {
  return http.post(`/get_workrequest_workarea_insert.php?`, data);
};

//Update WorkRequest Status
const get_workrequest_workarea_update = (data) => {
  return http.post(`/get_workrequest_workarea_update.php?`, data);
};
...
const get_workrequest_location = (site_cd) => {
  return http.get(`/get_workrequest_location.php?site_cd=${site_cd}`);
};
...
const get_workrequest_location_insert = (data) => {
  return http.post(`/get_workrequest_location_insert.php?`, data);
};

//Update WorkRequest Location
const get_workrequest_location_update = (data) => {
  return http.post(`/get_workrequest_location_update.php?`, data);
};
...
const get_workrequest_level = (site_cd) => {
  return http.get(`/get_workrequest_level.php?site_cd=${site_cd}`);
};
...
const get_workrequest_level_insert = (data) => {
  return http.post(`/get_workrequest_level_insert.php?`, data);
};

//Update WorkRequest Level
const get_workrequest_level_update = (data) => {
  return http.post(`/get_workrequest_level_update.php?`, data);
};
